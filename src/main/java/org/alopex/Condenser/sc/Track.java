package org.alopex.Condenser.sc;
...
public class Track {
	...
	public String getStreamUrl(SoundCloud sc) {
		if(this.stream_url != null && !this.stream_url.equals("")) {
			String stream_url = this.stream_url + "/?client_id=" + sc.app_client_id;
			stream_url = stream_url.replace("https://", "http://");
			HttpResponse data = null;
			try {
				data = sc.wrapper.get(Request.to(stream_url));
			} catch (IOException e) {}
